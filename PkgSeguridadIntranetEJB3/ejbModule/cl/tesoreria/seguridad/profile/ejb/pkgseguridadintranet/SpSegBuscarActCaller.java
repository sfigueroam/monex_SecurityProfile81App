 ...
 */
public class SpSegBuscarActCaller extends ProcedureCaller
{
    /**
     * Executes the "SEGURIDAD2.PKG_SEGURIDAD_INTRANET.SP_SEG_BUSCAR_ACT" database procedure.
     *
     ...
     */
    public static SpSegBuscarActResult execute(DataSource dataSource, String iVisible, BigDecimal iPage)
        throws java.sql.SQLException
    {
        SpSegBuscarActResult result = new SpSegBuscarActResult();
        ...
        try
        {
            ...
            {
                CallableStatement call = conn.prepareCall("{call SEGURIDAD2.PKG_SEGURIDAD_INTRANET.SP_SEG_BUSCAR_ACT(?,?,?,?)}");
                try
                {
                    call.registerOutParameter(1, Types.NUMERIC);
                    call.registerOutParameter(2, ORACLE_CURSOR);
                    call.setString(3, iVisible);
                    call.setBigDecimal(4, iPage);
