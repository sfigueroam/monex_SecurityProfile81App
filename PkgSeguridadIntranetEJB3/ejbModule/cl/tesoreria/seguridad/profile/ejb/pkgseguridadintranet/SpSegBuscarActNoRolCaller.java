 ...
 */
public class SpSegBuscarActNoRolCaller extends ProcedureCaller
{
    /**
     ...
     */
    public static SpSegBuscarActNoRolResult execute(DataSource dataSource, String iVisible, BigDecimal iRol)
        throws java.sql.SQLException
    {
        SpSegBuscarActNoRolResult result = new SpSegBuscarActNoRolResult();
        ...
        try
        {
            ...
            {
                CallableStatement call = conn.prepareCall("{call SEGURIDAD2.PKG_SEGURIDAD_INTRANET.SP_SEG_BUSCAR_ACT_NO_ROL(?,?,?,?)}");
                try
                {
